...
if(age > 65) {console.log("Your check is in the mail.")}
    //second if your age is equal to the retirementAge
if(age = 65) {console.log("Congratulations on retirement! Your check is in the mail. ")} ;
    //third if your age is younger than the retirementAge
if(age < 65) {console.log("Try again in a few years youngun.")};
}
